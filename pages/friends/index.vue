          ...
          <ul class="friends">
            <li class="friend-item">
              ...
              <div class="fl content">
                <p class="title"><span class="name">全栈大牛</span> 邀你一起 <span class="cafe">喝咖啡</span> <b class="bold">匹配度
                  96%</b></p>
            ...
            <li class="friend-item">
              ...
              <div class="fl content">
                <p class="title"><span class="name">全栈大牛</span> 邀你一起 <span class="eat">吃饭</span> <b class="bold">匹配度
                  96%</b></p>
                <p class="aa"><span class="money"> 24岁 | 金牛座 | 教育 | 软件工程师</span></p>
                <p class="point">他刚刚分享了XXX文章</p>
                <p class="desc">推荐理由：你们共同关注PHP、Python 等 5 个标签，都关注 XXX 活动。</p>
            ...
            <li class="friend-item">
              ...
              <div class="fl content">
                <p class="title"><span class="name">全栈大牛</span> 邀你一起 <span class="travel">旅行</span><b class="bold">匹配度
                  96%</b></p>
                <p class="aa"><span class="money"> 24岁 | 金牛座 | 教育 | 软件工程师</span></p>
                <p class="point">他刚刚分享了XXX文章</p>
                <p class="desc">推荐理由：你们共同关注PHP、Python 等 5 个标签，都关注 XXX 活动。</p>
            ...
            <li class="friend-item">
              ...
              <div class="fl content">
                <p class="title"><span class="name">全栈大牛</span> 邀你一起<span class="sing">K歌</span><b class="bold">匹配度
                  96%</b></p>
                <p class="aa"><span class="money"> 24岁 | 金牛座 | 教育 | 软件工程师</span></p>
                <p class="point">他刚刚分享了XXX文章</p>
                <p class="desc">推荐理由：你们共同关注PHP、Python 等 5 个标签，都关注 XXX 活动。</p>
            ...
            <li class="friend-item">
              ...
              <div class="fl content">
                <p class="title"><span class="name">全栈大牛</span> 邀你一起<span class="movie">看电影</span><b class="bold">匹配度
                  96%</b></p>
                <p class="aa"><span class="money"> 24岁 | 金牛座 | 教育 | 软件工程师</span></p>
                <p class="point">他刚刚分享了XXX文章</p>
                <p class="desc">推荐理由：你们共同关注PHP、Python 等 5 个标签，都关注 XXX 活动。</p>
            ...
            <li class="friend-item">
              ...
              <div class="fl content">
                <p class="title"><span class="name">全栈大牛</span> 邀你一起 <span class="other">其他</span><b class="bold">匹配度
                  96%</b></p>
                <p class="aa"><span class="money"> 24岁 | 金牛座 | 教育 | 软件工程师</span></p>
                <p class="point">他刚刚分享了XXX文章</p>
                <p class="desc">推荐理由：你们共同关注PHP、Python 等 5 个标签，都关注 XXX 活动。</p>
