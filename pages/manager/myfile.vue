      ...
      <div class="file-edit">
        <div class="info">
          ...
          <div class="sui-row-fluid person canadd">
            <div class="span4 item">
              ...
              <img src="~/assets/img/widget-o-photo.png" alt="">
            </div>
            <div class="span4 item">
                ...
                <div class="sui-row-fluid">
                  <div class="span6">
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input type="text" id="name" class="input-large" placeholder="真实姓名" name="name">
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label">出生日期</label>
                      <div class="controls">
                        <input type="text" id="birthday" class="input-large" placeholder="1970/01/01" name="birthday">
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label">手机号码</label>
                      <div class="controls">
                        <input type="text" id="telphone" class="input-large" placeholder="11位手机号码" name="telphone">
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label">现居城市</label>
                      <div class="controls">
                        <input type="text" id="city" class="input-large" placeholder="当前现居城市" name="city">
                      </div>
                    </div>
                  </div>
                  <div class="span6">
                    <div class="control-group" style="height: 60px;">
                      ...
                      <div class="controls">
                        <label data-toggle="radio" class="radio-pretty inline checked">
                          <input type="radio" checked="checked" name="qudao"><span>保密</span>
                        </label>
                        <label data-toggle="radio" class="radio-pretty inline">
                          <input type="radio" name="qudao"><span>男</span>
                        </label>
                        <label data-toggle="radio" class="radio-pretty inline">
                          <input type="radio" name="qudao"><span>女</span>
                        </label>
                      </div>
                    </div>
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input type="text" id="net" class="input-large" placeholder="example.com" name="net">
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label">Email</label>
                      <div class="controls">
                        <input type="text" id="email" class="input-large" placeholder="用于收取通知，找回密码" name="email">
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label">通讯地址</label>
                      <div class="controls">
                        <input type="text" id="city" class="input-large" placeholder="当前通讯地址" name="city">
                      </div>
                    </div>
          ...
          <div class="skill canadd">
            ...
            <!-- skill form -->
            <form action="" class="sui-form form-show form-skill">
              <div class="tags-area">
        ...
        <div class="canadd">
          ...
          <div class="add-list">
            <li>
              <h3>
                <span class="add-name">传智播客-产品经理</span>
                <span class="gray edit"><i class="fa fa-pencil" aria-hidden="true"></i> 编辑</span>
              </h3>
          ...
          <div class="form-show">
            <form action="" class="sui-form">
              <div class="sui-row-fluid">
                <div class="span6">
                  <div class="control-group">
                    <label class="control-label">公司/组织名称</label>
                    <div class="controls">
                      <input type="text" id="company" class="input-large" placeholder="公司/组织名称" name="company">
                    </div>
                  </div>
                ...
                <div class="control-group">
                  <label class="control-label">相关技术</label>
                  <div class="controls">
                    <input type="text" placeholder="标签，如:php可使用逗号，分号； 来分隔" class="input-xfat input-xxlarge" id="tags">
                  </div>
                </div>
              ...
              <div class="sui-row-fluid">
                ...
                <div class="span6">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                                <span class="sui-dropdown dropdown-bordered select"><span class="dropdown-inner"><a
                                  id="drop4" role="button" data-toggle="dropdown" href="#" class="dropdown-toggle">
                ...
                <div class="control-group">
                  <label class="control-label">取得成就</label>
                  <div class="controls">
